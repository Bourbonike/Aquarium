...
public final class ItemPageBinding implements ViewBinding {
  ...
  private ItemPageBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardView,
  ...
  public static ItemPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPageBinding((ConstraintLayout) rootView, cardView, imageView, scrollView,
